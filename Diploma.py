...
for_vk_input = input(
    ...
    'Затем нажмите Enter. \nВнимание! Если вы введете число, которое больше чем 50, '
    'то сервис Яндекс.Диск выдаст максимум 50 фотографий.\n'
...
class VKUser:
    ...
    def get_list_of_fourth_task_paragraph(self):
        ...
        for i in lst_of_small_dicts:
            i['file_size'] = 'z'  # Это просто требоволось в output задания.
